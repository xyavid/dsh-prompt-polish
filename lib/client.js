// source-hash c5ce1d81b1b0
window.__ModuleLoader__.load({
	id: "@xyavid/dsh-prompt-polish",
	factory: (require) => {
		var module = { exports: {} };
...
var REPO_URL = true ? "https://github.com/xyavid/dsh-prompt-polish" : "";
...
function PolishButton(props) {
  ...
  const undoWindowMsRef = (0, import_react.useSyncExternalStore)(subscribeUndoWindow, undoWindowValue, undoWindowValue) ?? UNDO_FALLBACK_MS;
  ...
  (0, import_react.useEffect)(() => {
    if (undo === void 0) return;
    if (undoWindowMsRef === void 0 || undoWindowMsRef <= 0) return;
    const timer = setTimeout(() => setUndo(void 0), undoWindowMsRef);
...
function applyInner(ctx) {
  ...
  ctx.inject(["slots", "configForms"], (slotsCtx) => {
    try {
